...
SDA_JWT_ACCESS_TOKEN_LIFETIME = env.int("SDA_JWT_ACCESS_TOKEN_LIFETIME", default=300)
SDA_JWT_REFRESH_TOKEN_LIFETIME = env.int("SDA_JWT_REFRESH_TOKEN_LIFETIME", default=60 * 60 * 24 * 7)
SDA_ACTIVATION_PERIOD = env.int("SDA_ACTIVATION_PERIOD", default=60 * 60 * 24)
SDA_PASSWORD_RESET_TIMEOUT = env.int("SDA_PASSWORD_RESET_TIMEOUT", default=60 * 60)
